...
**Stakers care primarily about their HETA balance.** While price is important in valuing their HETA and determining the rate at which it grows, it is not the main goal. A smart staker cares only about the short and long term growth prospects of the network. That growth translates into wealth via price and balance growth.

**Bonders care primarily about HETA price.** When they bond, these users lock in a fixed reward in HETA. Therefore, network profitability is only helpful in calculating opportunity cost or gain; bonders have their HETA gains locked in.

The ideal scenario for a bonder is for price to go up; in this case, the bonder benefits from their discount on HETA and the increase in price.
...
Contractions are conceivably only triggered by short-term liquidity crises. Since HETA holders have a guarantee that price will come back above intrinsic value eventually, the only sellers below should be those who need a short term exit and are willing to take the extra loss.
